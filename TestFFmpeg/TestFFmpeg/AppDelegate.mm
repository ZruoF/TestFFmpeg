...
- (NSURL *)applicationDocumentsDirectory {
  ...
  // code uses a directory named "com.zruof.TestFFmpeg" in the application's
  // documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
  ...
  NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TestFFmpeg"
                                            withExtension:@"momd"];
  _managedObjectModel =
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
  ...
  NSURL *storeURL = [[self applicationDocumentsDirectory]
      URLByAppendingPathComponent:@"TestFFmpeg.sqlite"];
  NSError *error = nil;
